    ...
    <header class="header__section">
                ...
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    <div class="header__shipping">
                        <ul class="header__shipping--wrapper d-flex">
                            <li class="header__shipping--text text-white">Welcome to SURCHI online Store</li>
                            
                            <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="/assets/img/icon/email.png" alt="email-icon"> <a class="header__shipping--text__link" href="mailto:surchi@gmail.com">surchi@gmail.com</a></li>
                        </ul>
                    </div>
            ...
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><router-link class="main__logo--link" to="/"><img class="main__logo--img" src="/assets/img/logo/nav-log.png" alt="logo-img"></router-link></h1>
                    </div>
                    ...
                    <div class="header__account header__sticky--none">
                        <ul class="d-flex">
                            <li class="header__account--items">
                                <RouterLink class="header__account--btn" to="/login">
                            ...
                            <li class="header__account--items d-none d-lg-block">
                                <RouterLink class="header__account--btn" to="/wishlist">
                    ...
                    <div class="header__menu d-none header__sticky--block d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items style2">
                                    <router-link class="header__menu--link" to="/about">About </router-link>  
                                </li>
                                <li class="header__menu--items style2">
                                    <router-link class="header__menu--link" to="/shop">Shop </router-link>  
                                </li>
                                <li class="header__menu--items style2">
                                    <router-link class="header__menu--link" to="/shop">Categories </router-link>  
                                </li>
                                <li class="header__menu--items style2">
                                    <router-link class="header__menu--link" to="/contact">Contact </router-link>  
                                </li>
                            </ul>
                        </nav>
                    </div>
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            <router-link class="offcanvas__menu_item" to="/">Home </router-link>  
                        </li>
                        <li class="offcanvas__menu_li">
                            <router-link class="offcanvas__menu_item" to="/about">About </router-link>  
                        </li>
                        <li class="offcanvas__menu_li">
                            <router-link class="offcanvas__menu_item" to="/shop">Shop </router-link>  
                        </li>
                        <li class="offcanvas__menu_li">
                            <router-link class="offcanvas__menu_item" to="/shop">Categories </router-link>  
                        </li>
                        <li class="offcanvas__menu_li">
                            <router-link class="offcanvas__menu_item" to="/contact">Contact </router-link>  
                        </li>
                    </ul>
                    <div class="offcanvas__account--items">
                        <router-link class="offcanvas__account--items__btn d-flex align-items-center" to="/login">
        ...
        <div class="offCanvas__minicart">
            ...
            <div class="minicart__button d-flex justify-content-center">
                <router-link class="primary__btn minicart__button--link" to="/cart">View cart</router-link>
                <router-link class="primary__btn minicart__button--link" to="/checkout">Checkout</router-link>
            </div>
        </div>
